...
# -*- coding: utf-8 -*-
"""
Моделирование двумерного случайного блуждания ТОЛЬКО с 8 направлениями.
Используется для отдельного запуска, когда результаты для 4 направлений уже есть.
"""
...
def main():
    """Главная функция - только для 8 направлений."""
    N = 10**4
    M = 10**8
    seed = 42
    batch_size = None
    ...
    print("=" * 60)
    print("МОДЕЛИРОВАНИЕ 2D СЛУЧАЙНОГО БЛУЖДАНИЯ - 8 НАПРАВЛЕНИЙ")
    print("=" * 60)
